...
const TABLE = 'hr_attendance_requests';

// POST /api/hr/ess/attendance-requests/[id]/cancel — the requester withdraws their
// OWN still-pending attendance correction request (§B/§J8). Auth-any, but ownership is
// enforced: only the requester may cancel, and only while the request is pending (not
// after a decision).
