...
export async function GET() {
  ...
  const { data, error } = await service
    .from(TABLE)
    .select('id, name, name_en, address, phone, tax_id, payslip_paper, sso_rate, sso_wage_ceiling_satang, day_divisor, ot_multipliers, wht_rate, sso_prorate, active, created_at')
