...
export async function GET(request: NextRequest) {
  ...
  // A missing row used to carry the person's `user_stores` venue codes, to chase them to a place.
  // Dropped 2026-09-04 (owner ask): payroll is run on (company × payroll group) and the venue codes
  // said nothing about which run someone belonged to — for the back-office staff who are members of
  // five venues each they were actively misleading. The slice already names the company and group,
  // which is the whole of what decides where a missing person should have been paid.
