...
import { Clock, History, Users, Plus, CalendarDays, FileBarChart } from 'lucide-react';
...
type CommissionTab = 'pending' | 'daily' | 'report' | 'history' | 'ae';
...
export default function CommissionPage() {
  ...
  const tabs = [
    ...
    { id: 'report', label: t('tabReport'), icon: <FileBarChart className="h-4 w-4" /> },
  ...
  return (
    <div className="mx-auto max-w-5xl space-y-4 p-4">
      ...
      {activeTab === 'report' && <CommissionReport month={month} refreshKey={refreshKey} rounded={rounded} />}
