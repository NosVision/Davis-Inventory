    ...
    <div className="mx-auto max-w-3xl space-y-4 p-4">
      ...
      <section className="space-y-3 rounded-xl border border-gray-200 bg-white p-4 dark:border-gray-700 dark:bg-gray-800">
        ...
        <div className="grid grid-cols-2 gap-3 sm:grid-cols-3">
          ...
          <Num label={L.t3} value={eff.late_tiers.tier3_satang_per_hour / 100} def={defs.late_tiers.tier3_satang_per_hour / 100} onChange={(n) => upd((d) => { d.late_tiers.tier3_satang_per_hour = Math.round(n * 100); })} />
        </div>
